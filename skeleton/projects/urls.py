...
urlpatterns = patterns('projects.views',
    ...
    url(r'^bibliography/reference/(?P<reference_id>\d+)/$',
        'reference_view', name='reference'),
    url(r'^research/(?P<research_id>\d+)/(?P<research_slug>.+)/$',
        'research_line_view', name='research_line'),
    url(r'^images/gallery/$', 'image_gallery_view', name='gallery'),
    url(r'^images/(?P<image_id>\d+)/(?P<image_slug>.+)/$',
        'image_view', name='image'),
